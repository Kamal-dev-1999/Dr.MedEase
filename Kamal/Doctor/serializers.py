...
class SignupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User  # Make sure this is referring to the correct User model
        fields = (
...
class DoctorAppointmentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'patient_name', 'appointment_date', 'appointment_time', 'symptoms', 'is_confirmed']
        
class DoctorAppointmentSerializer(serializers.ModelSerializer):
    class Meta:
        model = DoctorAppointment
        fields = ['id', 'patient_name', 'patient_contact', 'appointment_date', 'appointment_time', 'symptoms', 'doctor', 'is_confirmed']
